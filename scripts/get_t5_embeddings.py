...
from cosmos_transfer2._src.predict2.inference.get_t5_emb import CosmosT5TextEncoder
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--cache_dir", type=str, default=None, help="Directory to cache the T5 model")
...
def main(args) -> None:
    ...
    # Initialize T5
    encoder = CosmosT5TextEncoder(model_name=args.cache_dir)
