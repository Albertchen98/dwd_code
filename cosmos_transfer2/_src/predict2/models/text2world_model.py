...
from cosmos_transfer2._src.predict2.text_encoders.t5_embedder import CosmosT5TextEncoder, CosmosT5TextEncoderConfig
...
class Text2WorldModelConfig:
    ...
    text_encoder_config: Optional[CosmosT5TextEncoderConfig] = None
    use_lora: bool = False
    lora_rank: int = 32
    lora_alpha: int = 32
...
class DiffusionModel(ImaginaireModel):
    ...
    def __init__(self, config: Text2WorldModelConfig):
        ...
        if self.config.text_encoder_config is not None and self.config.text_encoder_config.compute_online:
            self.text_encoder = CosmosT5TextEncoder(self.config.text_encoder_config)
