...
class TextEncoderConfig:
    ...
    ckpt_path: str = "/home/ma-user/work/x50026424/cosmos-transfer2.5/nvidia/Cosmos-Reason1-7B"
...
if __name__ == "__main__":
    sample_text = "A beautiful scenery with mountains and a lake."
    embeddings = get_reason1_embeddings(sample_text)
    print(f"Embeddings shape: {embeddings.shape}")  # Should print (1, seq len, d)