...
vid2vid_2B_control_720p_t24_control_layer4_cr1pt1_embedding_rectified_flow = LazyDict(
    dict(
        ...
        model=dict(
            config=dict(
                ...
                text_encoder_config=dict(
                    ...
                    ckpt_path="./model_hubs/nvidia/Cosmos-Reason1-7B",
                ),
                base_load_from=None,
                hint_keys="edge",
            )
        ...
        checkpoint=dict(
            ...
            load_training_state=False,
            strict_resume=False,
            load_path="./model_hubs/nvidia/Cosmos-Predict2.5-2B/base/post-trained/81edfebe-bd6a-4039-8c1d-737df1a790bf_ema_bf16.pt",
        ),
        model_parallel=dict(
            context_parallel_size=8,
        ),
...
vid2vid_2B_control_720p_t24_dinocontrol_layer4_cr1_embedding_rectified_flow_train_keyframe = LazyDict(
    dict(
        defaults=[
            {"override /data_train": "nuplan_video"},
            {"override /model": "fsdp_dino_control_vace_rectified_flow"},
            {"override /net": "transfer2_dinocontrol2world_net_2B"},
            {"override /conditioner": "video_prediction_control_conditioner"},
            {"override /ckpt_type": "dcp"},
            {"override /optimizer": "adamw"},
            {
            ...
            {"override /checkpoint": "s3"},
            {"override /tokenizer": "wan2pt1_tokenizer"},
            {"override /dinov3_encoder": "dinov3_vitl16"},
            "_self_",
        ],
        job=dict(
            group="vid2vid_2B_control",
            name="vid2vid_2B_control_720p_t24_dinocontrol_layer4_cr1_embedding_rectified_flow_train_keyframe",
            wandb_mode="disabled",
        ),
        optimizer=dict(
            lr=8.63e-5,  # 2**(-14.5) = 3.0517578125e-05
...
# fit the requirement of training with preprocessed dino latent--> especially for anyup+pca setup
vid2vid_2B_control_720p_t24_dino_prep_control_layer4_cr1_embedding_rectified_flow_train_keyframe = LazyDict(
    dict(
        defaults=[
            {"override /data_train": "nuplan_video"},
            {"override /model": "fsdp_dino_prep_control_vace_rectified_flow"},
            {"override /net": "transfer2_dinocontrol2world_net_2B"},
            {"override /conditioner": "video_prediction_control_conditioner"},
            {"override /ckpt_type": "dcp"},
            {"override /optimizer": "adamw"},
        ...
        job=dict(
            group="vid2vid_2B_control",
            name="vid2vid_2B_control_720p_t24_dino_prep_control_layer4_cr1_embedding_rectified_flow_train_keyframe",
            wandb_mode="disabled",
        ),
        optimizer=dict(
            lr=8.63e-5,  # 2**(-14.5) = 3.0517578125e-05
...
vid2vid_2B_control_720p_t24_dinoedgecontrol_layer4_cr1_embedding_rectified_flow_train_keyframe = LazyDict(
    dict(
        defaults=[
            {"override /data_train": "waymo_video"},
            {"override /model": "fsdp_dino_edge_control_vace_rectified_flow"},
            {"override /net": "transfer2_dinoedgecontrol2world_net_2B"},
            {"override /conditioner": "video_prediction_control_conditioner"},
            {"override /ckpt_type": "dcp"},
            {"override /optimizer": "adamw"},
            {
        ...
        job=dict(
            group="vid2vid_2B_control",
            name="vid2vid_2B_control_720p_t24_dinoedgecontrol_layer4_cr1_embedding_rectified_flow_train_keyframe",
        ),
        optimizer=dict(
            lr=8.63e-5,  # 2**(-14.5) = 3.0517578125e-05
            weight_decay=1e-3,
...
for _item, _item_debug, _item_wo_resume, _item_mock_wo_resume in [
    ...
    [
        vid2vid_2B_control_720p_t24_dinocontrol_layer4_cr1_embedding_rectified_flow_train_keyframe,
        *build_debug_runs(vid2vid_2B_control_720p_t24_dinocontrol_layer4_cr1_embedding_rectified_flow_train_keyframe),
    ],
    [
        vid2vid_2B_control_720p_t24_dino_prep_control_layer4_cr1_embedding_rectified_flow_train_keyframe,
        *build_debug_runs(vid2vid_2B_control_720p_t24_dino_prep_control_layer4_cr1_embedding_rectified_flow_train_keyframe),
    ],
    [
        vid2vid_2B_control_720p_t24_dinoedgecontrol_layer4_cr1_embedding_rectified_flow_train_keyframe,
        *build_debug_runs(vid2vid_2B_control_720p_t24_dinoedgecontrol_layer4_cr1_embedding_rectified_flow_train_keyframe),
    ],
