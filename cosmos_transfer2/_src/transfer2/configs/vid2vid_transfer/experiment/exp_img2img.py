...
img2img_2B_control_720p_control_layer4_cr1_embedding = LazyDict(
    dict(
        defaults=[
            {"override /data_train": "nuplan_image"},
            {"override /model": "ddp_control_vace"},
            {"override /net": "transfer2_control2image_net_2B"},
        ...
        job=dict(
            group="img2img_2B_control",
            name="img2img_2B_control_720p_control_layer4_cr1_embedding",
        ),
        optimizer=dict(
...
img2img_2B_control_720p_dinocontrol_layer4_t5_embedding = LazyDict(
    dict(
        defaults=[
            {"override /data_train": "nuplan_image"},
            {"override /model": "ddp_dino_control_vace"},
            {"override /net": "transfer2_dinocontrol2image_net_2B"},
            {"override /conditioner": "video_prediction_control_conditioner"},
            {"override /ckpt_type": "dcp"},
            {"override /optimizer": "adamw"},
            {
        ...
        job=dict(
            group="img2img_2B_control",
            name="img2img_2B_control_720p_dinocontrol_layer4_t5_embedding",
        ),
        optimizer=dict(
            lr=8.63e-5,  # 2**(-14.5) = 3.0517578125e-05
            weight_decay=1e-3,
        ...
        model=dict(
            config=dict(
                ...
                tokenizer=dict(
                    temporal_window=16,
                    compile_encode=True,
                    vae_pth="/cache/checkpoints/Cosmos-Predict2.5-2B/tokenizer.pth",
                ),
                text_encoder_class="T5",
                text_encoder_config=dict(
                    # compute_online=True,
...
img2img_2B_control_720p_dinoedge_control_layer4_cr1_embedding = LazyDict(
    dict(
        defaults=[
            {"override /data_train": "nuplan_image"},
            {"override /model": "ddp_dino_edge_control_vace"},
            {"override /net": "transfer2_dinoedge_control2image_net_2B"},
            {"override /conditioner": "video_prediction_control_conditioner"},
            {"override /ckpt_type": "dcp"},
            {"override /optimizer": "adamw"},
            {
        ...
        job=dict(
            group="img2img_2B_control",
            name="img2img_2B_control_720p_dinoedge_control_layer4_cr1_embedding",
        ),
        optimizer=dict(
            lr=8.63e-5,  # 2**(-14.5) = 3.0517578125e-05
            weight_decay=1e-3,
...
cs.store(
            group="experiment",
            package="_global_",
            name=f"{img2img_2B_control_720p_control_layer4_cr1_embedding['job']['name']}",
            node=img2img_2B_control_720p_control_layer4_cr1_embedding,
        ) 
cs.store(
            group="experiment",
            package="_global_",
            name=f"{img2img_2B_control_720p_dinocontrol_layer4_t5_embedding['job']['name']}",
            node=img2img_2B_control_720p_dinocontrol_layer4_t5_embedding,
        )  
cs.store(
            group="experiment",
            package="_global_",
            name=f"{img2img_2B_control_720p_dinoedge_control_layer4_cr1_embedding['job']['name']}",
            node=img2img_2B_control_720p_dinoedge_control_layer4_cr1_embedding,
        )    
