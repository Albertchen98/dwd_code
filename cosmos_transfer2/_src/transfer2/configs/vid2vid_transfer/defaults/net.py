...
from cosmos_transfer2._src.transfer2.networks.minimal_v4_lvg_dit_control_vace_dino import MinimalV4LVGControlVaceDiT as MinimalV4LVGControlVaceDiTDino
from cosmos_transfer2._src.transfer2.networks.minimal_v4_lvg_dit_control_vace_dino_edge import MinimalV4LVGControlVaceDiT as MinimalV4LVGDinoEdgeControlVaceDiT
...
TRANSFER2_DINOCONTROL2WORLD_NET_2B = L(MinimalV4LVGControlVaceDiTDino)(
    max_img_h=240,
    max_img_w=240,
    max_frames=128,
    in_channels=16,
    ...
    use_dino_pca=False,
    dino_merge_upfactor=1,
    sample_dino_key_frame=True,
)

TRANSFER2_DINOEDGECONTROL2WORLD_NET_2B = L(MinimalV4LVGDinoEdgeControlVaceDiT)(
    max_img_h=240,
    max_img_w=240,
    max_frames=128,
    in_channels=16,
...
def register_net():
    ...
    cs.store(
        group="net",
        package="model.config.net",
        name="transfer2_dinocontrol2world_net_2B",
        node=TRANSFER2_DINOCONTROL2WORLD_NET_2B,
    )
    cs.store(
        group="net",
        package="model.config.net",
        name="transfer2_dinoedgecontrol2world_net_2B",
        node=TRANSFER2_DINOEDGECONTROL2WORLD_NET_2B,
    )
