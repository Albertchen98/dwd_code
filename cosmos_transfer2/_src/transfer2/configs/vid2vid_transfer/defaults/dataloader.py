...
from cosmos_transfer2._src.transfer2.configs.vid2vid_transfer.defaults.waymo_dataset import (WAYMO_DATA_VIDEO_ONLY_CONFIG,
NUPLAN_DATA_VIDEO_ONLY_CONFIG,
NUPLAN_DATA_IMAGE_ONLY_CONFIG
)
...
def register_training_and_val_data():
    ...
    cs.store(group="data_train", package="dataloader_train", name="waymo_video", node=WAYMO_DATA_VIDEO_ONLY_CONFIG)
    cs.store(group="data_train", package="dataloader_train", name="nuplan_video", node=NUPLAN_DATA_VIDEO_ONLY_CONFIG)
    cs.store(group="data_val", package="dataloader_val", name="nuplan_video", node=NUPLAN_DATA_VIDEO_ONLY_CONFIG)
    cs.store(group="data_train", package="dataloader_train", name="nuplan_image", node=NUPLAN_DATA_IMAGE_ONLY_CONFIG)
