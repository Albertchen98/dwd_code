...
class ControlDino2ImageRectifiedFlowConfig(Video2WorldModelRectifiedFlowConfig):
...
class ControlDino2ImageModelRectifiedFlow(Video2WorldModelRectifiedFlow):
    """
    ImaginaireModel instance of the VACE-styled controlnet for training.
    """

    def __init__(self, config: ControlDino2ImageRectifiedFlowConfig, *args, **kwargs):
