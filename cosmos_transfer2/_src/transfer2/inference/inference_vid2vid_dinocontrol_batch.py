...
def process_single_video(
    ...
    inference_kwargs = {
        ...
        "use_prep_anyup_feature": args.use_prep_anyup_feature,
        "prep_anyup_feature_channel": args.prep_anyup_feature_channel,
        "anyup_factor": args.anyup_factor,
    }
    # Run model inference
